...
function getBookFromArray(param) {
...
function buildBook(title, author, year) {
    const idOmitBook = { title, author, year };
    const book = Object.assign({ id: bookIdIncrementer() }, idOmitBook);
    return book;
}
function bookIdIncrementer() {
    if (books.length === 0)
        return 1;
